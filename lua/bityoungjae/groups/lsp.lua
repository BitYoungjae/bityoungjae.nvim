...
function M.setup(hl, p)
  ...
  hl(0, "@lsp.type.comment", { fg = p.comment, italic = italic_comments })
  ...
  hl(0, "@lsp.type.keyword", { fg = p.keyword, bold = true })
  ...
  hl(0, "LspReferenceText", { bg = p.bg_ref })
  hl(0, "LspReferenceRead", { bg = p.bg_ref })
  hl(0, "LspReferenceWrite", { bg = p.bg_ref })
